...
import os
from services.validation_service import validate_checklist_data, validate_checklist_item_data
...
def update_item(item_id):
    ...
    try:
        ...
        cur.execute(
            ...
            (data.get('title'), data.get('completed', False), data.get('order_index', 0), item_id)
        )
        item = cur.fetchone()
